...
class About(Screen):
	def __init__(self, session):
		...
		if boxtype == 'vusolo2':
			BoxName = "VuSolo2 Sodo Build"
		elif boxtype == 'vuzero':
			BoxName = "VuZero Sodo Build"
		elif boxtype == 'vuuno':
			BoxName = "vuuno Sodo Build"
                elif boxtype == 'vuultimo':
			BoxName = "vuultimo Sodo Build"
                elif boxtype == 'vusolo':
			BoxName = "vusolo Sodo Build" 
		else:
		...
		PythonVersion = _("Python version: ") + about.getPythonVersionString() + "\n"
		self["PythonVersion"] = StaticText(PythonVersion)
		AboutText += PythonVersion + "\n"
