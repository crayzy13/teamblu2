...
def InitUsageConfig():
	...
	config.usage.pic_resolution = ConfigSelection(default="Same resolution as skin", choices=[(None, _("Same resolution as skin")), ("(720, 576)","720x576"), ("(1280, 720)", "1280x720"), ("(1920, 1080)", "1920x1080")][:SystemInfo["HasFullHDSkinSupport"] and 4 or 3])
